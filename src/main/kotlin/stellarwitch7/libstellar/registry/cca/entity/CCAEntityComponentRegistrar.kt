...
abstract class CCAEntityComponentRegistrar : CCAComponentRegistrar<EntityComponentFactoryRegistry>, EntityComponentInitializer {
    ...
    fun <C : Component, T : Entity> register(name: String, c: KClass<C>, factory: (T) -> C, t: KClass<T>): ComponentKey<C> {
        return register(makeKey(name, c), factory, t)
    }

    fun <C : Component, T : Entity> register(key: ComponentKey<C>, factory: (T) -> C, t: KClass<T>): ComponentKey<C> {
